...
int DisplayMinMarks(Student *sArr,int *iPtr)
{
    float fMin = sArr[0].fMarks;
...
int DisplayMaxMarks(Student *sArr,int *iPtr)
{
    float fMax = sArr[0].fMarks;
...
int main()
{
    ...
    while(1)
    {
        ...
        else if(iChoise == 6)
        {
            ...
            fMin = DisplayMinMarks(sArr,&iCount);
        ...
        else if(iChoise == 7)
        {
            ...
            fMax = DisplayMaxMarks(sArr,&iCount);
